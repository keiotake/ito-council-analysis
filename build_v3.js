...
.nav-more-btn:hover{background:#f1f5f9;color:#0a0a0a;border-color:#cbd5e1}
.nav-more-btn.sub-active{background:#0f172a;color:#fff;border-color:#0f172a}
...
.nav-more-divider{height:1px;background:var(--border);margin:.4rem .2rem}
