...
.m-avatar{width:72px;height:72px;border-radius:50%;margin:0 auto .6rem;display:flex;align-items:center;justify-content:center;font-size:2rem;font-weight:800;color:#fff;border:3px solid rgba(255,255,255,.6);box-shadow:0 2px 6px rgba(0,0,0,.12);background-image:linear-gradient(135deg,rgba(255,255,255,.18),rgba(0,0,0,.05))}
...
.m-avatar-fb{width:100%;height:100%;display:flex;align-items:center;justify-content:center;font-size:2rem;font-weight:800;color:#fff;background-image:linear-gradient(135deg,rgba(255,255,255,.18),rgba(0,0,0,.05))}
